  ...
  return (
    <div className="flex h-screen bg-background">
      ...
      <div className="hidden lg:flex lg:flex-shrink-0">
        <div className="flex flex-col w-64 border-r border-border bg-gradient-to-b from-gray-50 to-gray-200 dark:from-neutral-900 dark:to-neutral-800 shadow-md min-h-screen">
      ...
      <div className="flex flex-col flex-1 overflow-hidden bg-gray-100 dark:bg-neutral-900">
        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-8">
          <div className="max-w-5xl mx-auto w-full bg-white dark:bg-neutral-800 rounded-2xl shadow-lg p-4 md:p-8 min-h-[80vh]">
            {children}
          </div>
        </main>
      </div>
